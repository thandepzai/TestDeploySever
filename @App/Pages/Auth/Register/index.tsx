		...
		<Row align="middle" justify="center" style={{ minHeight: '90vh' }}>
			...
			>
				<Row justify="center" style={{ marginBottom: 20 }}>
					...
					<Divider style={{ color: 'blue' }}>Đăng ký tài khoản</Divider>
				</Row>
				<Form name="normal_login" initialValues={{ remember: true }} onFinish={handleSubmit}>
					<Form.Item name="name" rules={[{ required: true, message: 'Vui lòng điền họ tên!' }]}>
					...
					>
						<Input prefix={<LockOutlined />} type="password" placeholder="Xác nhận mật khẩu" />
					</Form.Item>
				...
				<Row justify="space-between">
					...
					<Col span={12}>
						<Row justify="end" gutter={[8, 8]}>
							<Col className="self-center">Đã có tài khoản?</Col>
							<Col>
