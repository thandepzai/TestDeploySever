...
const CardDataStats: React.FC<CardDataStatsProps> = ({ title, total, levelUp, levelDown, children }) => {
	return (
		<div className="rounded-sm border border-stroke bg-white py-6 px-7 shadow-default">
			<div className="flex h-11.5 w-11.5 items-center justify-start rounded-full bg-meta-2">{children}</div>
